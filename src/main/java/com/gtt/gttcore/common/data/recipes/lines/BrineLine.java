...
import static com.gtt.gttcore.common.data.recipes.GTTRecipeTypes.EVAPORATION_RECIPES;
...
public class BrineLine {
    ...
    private static void bromineProcess(Consumer<FinishedRecipe> provider) {
        ...
        CHEMICAL_RECIPES.recipeBuilder(GTTCore.id("brine_filtration"))
        ...
        CHEMICAL_RECIPES.recipeBuilder(GTTCore.id("brominated_chlorine_vapor_condensation"))
                .inputFluids(BrominatedChlorineVapor.getFluid(1000))
                .inputFluids(Water.getFluid(1000))
                .outputFluids(AcidicBromineSolution.getFluid(1000))
                .outputFluids(Water.getFluid(1000))
                .duration(200).EUt(VA[HV]).save(provider);
        CHEMICAL_RECIPES.recipeBuilder(GTTCore.id("bromine_vapor_concentration"))
                ...
                .duration(100).EUt(VA[HV]).save(provider);
        DISTILLATION_RECIPES.recipeBuilder(GTTCore.id("bromine_distillation"))
        ...
        // byproduct loop
        CHEMICAL_RECIPES.recipeBuilder(GTTCore.id("brine_neutralization"))
                ...
                .duration(100).EUt(VA[HV]).save(provider);
        CHEMICAL_RECIPES.recipeBuilder(GTTCore.id("debrominated_brine_raw_brine_mixing"))
                .inputFluids(RawBrine.getFluid(1000))
                .inputFluids(HotDebrominatedBrine.getFluid(1000))
                .outputFluids(HotBrine.getFluid(1000))
                .outputFluids(DebrominatedBrine.getFluid(1000))
                .duration(200).EUt(VA[HV]).save(provider);
        CHEMICAL_RECIPES.recipeBuilder(GTTCore.id("acidic_bromine_exhaust_heating"))
        ...
        CENTRIFUGE_RECIPES.recipeBuilder(GTTCore.id("debrominated_brine_decomposition"))
    ...
    public static void iodineProcess(Consumer<FinishedRecipe> provider) {
        CHEMICAL_RECIPES.recipeBuilder(GTTCore.id("brine_acidification"))
        ...
        CHEMICAL_RECIPES.recipeBuilder(GTTCore.id("iodine"))
