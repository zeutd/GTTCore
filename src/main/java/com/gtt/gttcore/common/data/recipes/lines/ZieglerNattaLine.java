...
public class ZieglerNattaLine {
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        DISTILLATION_RECIPES.recipeBuilder(GTTCore.id("cultivate_products_distillation"))
                ...
                .EUt(VH[3])
                .save(provider);
        CHEMICAL_RECIPES.recipeBuilder(GTTCore.id("butanol_from_butene"))
                .inputFluids(Butene.getFluid(1000))
                .inputFluids(Water.getFluid(1000))
                .outputFluids(Butanol.getFluid(1000))
                .save(provider);
        CHEMICAL_RECIPES.recipeBuilder(GTTCore.id("sodium_bromide"))
                .inputItems(dust, Sodium)
                .inputFluids(Bromine.getFluid(1000))
                .outputItems(dust, SodiumBromide)
                .duration(100)
                .EUt(VH[2])
                .save(provider);
        CHEMICAL_RECIPES.recipeBuilder(GTTCore.id("bromobutane"))
        ...
        CHEMICAL_RECIPES.recipeBuilder(GTTCore.id("octanol"))
                ...
                .EUt(VH[2])
                .save(provider);
        CHEMICAL_RECIPES.recipeBuilder(GTTCore.id("octanol_magnesium"))
                .inputFluids(Octanol.getFluid(2000))
                .inputFluids(DibutylMagnesium.getFluid(1000))
        ...
        CHEMICAL_RECIPES.recipeBuilder(GTTCore.id("phthaloyl_chlorine"))
                ...
                .outputItems(dust, PhosphorusTrioxide)
                .outputFluids(Water.getFluid(2000))
                .duration(100)
                .EUt(VH[3])
                .save(provider);
        CHEMICAL_RECIPES.recipeBuilder(GTTCore.id("phosphorus_trichloride"))
                ...
                .EUt(VH[3])
                .save(provider);
        CHEMICAL_RECIPES.recipeBuilder(GTTCore.id("microcrystal_magnesium_chloride_dust"))
                ...
                .EUt(VH[3])
                .save(provider);
        FORGE_HAMMER_RECIPES.recipeBuilder(GTTCore.id("magnesium_chloride_dust_from_microcrystal_magnesium_chloride_dust"))
                .inputItems(dust, MicrocrystalMagnesiumChloride)
                .outputItems(dust, MagnesiumChloride)
                .duration(20)
                .EUt(VH[1])
                .save(provider);
        CHEMICAL_RECIPES.recipeBuilder(GTTCore.id("ziegler_natta"))
                .inputItems(dust, MicrocrystalMagnesiumChloride)
