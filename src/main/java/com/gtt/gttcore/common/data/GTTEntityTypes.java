...
public class GTTEntityTypes {
    public static final EntityEntry<BlackholeBombEntity> BLACKHOLE_BOMB = REGISTRATE
            .<BlackholeBombEntity>entity(LangUtil.createEntityZhTranslation("blackhole_bomb", "黑洞炸弹"), BlackholeBombEntity::new, MobCategory.MISC)
    ...
    public static final EntityEntry<NuclearBombEntity> NUCLEAR_BOMB = REGISTRATE
            .<NuclearBombEntity>entity(LangUtil.createEntityZhTranslation("nuclear_bomb", "核弹"), NuclearBombEntity::new, MobCategory.MISC)
            .lang("Nuclear Bomb")
            .properties(builder -> builder.sized(0.98F, 0.98F).fireImmune().clientTrackingRange(10).updateInterval(10))
            .register();
    public static final EntityEntry<BlackholeEntity> BLACKHOLE = REGISTRATE
            .<BlackholeEntity>entity(LangUtil.createEntityZhTranslation("blackhole", "黑洞"), BlackholeEntity::new, MobCategory.MISC)
            .lang("Black Hole")
    ...
    public static final EntityEntry<MushroomCloudEntity> MUSHROOM_CLOUD = REGISTRATE
            .<MushroomCloudEntity>entity(LangUtil.createEntityZhTranslation("mushroom_cloud", "蘑菇云"), MushroomCloudEntity::new, MobCategory.MISC)
            .lang("Mushroom Cloud")
